...
public class WinningTransactionReplicaDAOTest extends
        BaseCrudJpaDAOTest<WinningTransactionReplicaDAO, WinningTransaction, WinningTransactionId> {
    ...
    @Autowired
    private WinningTransactionReplicaDAO dao;


    @Override
    protected CriteriaQuery<? super WinningTransaction> getMatchAlreadySavedCriteria() {
        WinningTransactionReplicaDAOTest.WinningTransactionCriteria criteriaQuery =
                new WinningTransactionReplicaDAOTest.WinningTransactionCriteria();
    ...
    @Override
    protected WinningTransactionReplicaDAO getDao() {
        return dao;
    }
