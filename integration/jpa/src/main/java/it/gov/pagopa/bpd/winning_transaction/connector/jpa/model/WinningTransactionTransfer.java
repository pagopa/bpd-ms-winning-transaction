...
@Table(name = "bpd_winning_transaction_transfer")
public class WinningTransactionTransfer extends BaseEntity implements Serializable, Persistable<WinningTransactionId> {
